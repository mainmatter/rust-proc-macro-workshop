...
> (chapter 1). Third-party attributes like `#[tokio::main]` _are_ procedural macros, and work
...
> [`cargo expand`](https://github.com/dtolnay/cargo-expand) as you did in chapter 1. The `eprintln!`
